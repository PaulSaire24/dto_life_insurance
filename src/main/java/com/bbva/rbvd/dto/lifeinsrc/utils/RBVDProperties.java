...
public enum RBVDProperties {
    ...
    DATO_PARTICULAR_EDAD_ASEGURADO("EDAD_ASEGURADO"),
    DATO_PARTICULAR_SUMA_ASEGURADA_COBERTURA_FALLECIMIENTO("SUMA_ASEGURADA_COBERTURA_FALLECIMIENTO"),
    DATO_PARTICULAR_PERIODO_ANOS("PERIODO_AÑOS"),
    DATO_PARTICULAR_PORCENTAJE_DEVOLUCION("PORCENTAJE_DEVOLUCION"),
