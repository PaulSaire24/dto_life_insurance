...
public enum RBVDProperties {
    ...
    QUERY_INSERT_PARTICIPANT_QOUTATION("PISD.INSERT_PARTICIPANT_QOUTATION"),
    ...
    QUERY_GET_INSURED_DATA_LIFE("PISD.GET_INSURED_DATA_LIFE"),
    QUERY_UPDATE_INSURANCE_QUOTATION("PISD.UPDATE_INSURANCE_QUOTATION"),
    ...
    FIELD_PERSONAL_DOCUMENT_ID("PERSONAL_DOCUMENT_ID"),
